...
int main(int argc, char * argv[])
{
  ...
  desc.add_options()
      ...
      ("kx", po::value<unsigned > (&KK[0])->default_value(60), "number of modes in dir x")
      ("ky", po::value<unsigned > (&KK[1])->default_value(60), "number of modes in dir y")
      ("kz", po::value<unsigned > (&KK[2])->default_value(60), "number of modes in dir z")
