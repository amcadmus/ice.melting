...
#include <cassert>
#include "CoordinationHillPairValue.h"
#include "SteinhardtHillPairValue.h"

using namespace std;

class SteinhardtHillAnalysisBase 
{
public:
  ...
  virtual ~SteinhardtHillAnalysisBase () {};
...
class SteinhardtHillAnalysis : public SteinhardtHillAnalysisBase
{
public :
  SteinhardtHillAnalysis (const double r0,
			  const double r1,
			  const double r2,
			  const double r3,
			  const int func_numb_threads = 1);
  virtual ~SteinhardtHillAnalysis () {};
...
private :
  ...
  int numb_step;
private:
  // SteinhardtHillPairValue<LL>	spv;
		 ...
		 const vector<vector<double > > & waters) 
{
  ...
  SteinhardtHillPairValue<LL> tmp_spv (r0, r1, r2, r3);
...
#pragma omp parallel for num_threads (func_numb_threads) 
  for (int tt = 0; tt < func_numb_threads; ++tt){ 
    SteinhardtHillPairValue<LL>	spv (r0, r1, r2, r3);
    CoordinationHillPairValue	cpv (r0, r2, r2, r3);
