...
int main(int argc, char * argv[])
{
  ...
  desc.add_options()
      ...
      ("output,o",  po::value<string > (&ofile)->default_value ("eigdist.out"), "the output file")
      ("output-dir",  po::value<string > (&odir)->default_value ("dir.eigdist"), "the output directory of Q value information");
